...
@section('content')
       <div>
           <button class="btn btn-info mb-3"><i class="fa fa-plus" aria-hidden="true"></i> 添加网站</button>
           <div class="card mb-3 shadow-sm">
               ...
               <div class="card-footer text-muted d-flex flex-column flex-sm-row justify-content-between">
                   ...
                   <div class="small">
                       <a href="https://www.houdunren.com" target="_blank" class="text-muted mr-2"><i aria-hidden="true"
                                                                                                      class="fa fa-home"></i>
                           访问首页
